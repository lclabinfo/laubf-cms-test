...
> Message + BibleStudy table merge documented in `docs/000-temp-docs-3-27/plans/message-biblestudy-proposed-schema.md`.
...
> `docs/000-temp-docs-3-27/plans/message-biblestudy-proposed-schema.md` section 10.
...
> `docs/000-temp-docs-3-27/plans/message-biblestudy-proposed-schema.md` for the full plan. Do NOT implement 3a or 3b
...
> individual R2 file lifecycle management). See `docs/000-temp-docs-3-27/plans/message-biblestudy-proposed-schema.md`.
...
| `docs/000-temp-docs-3-27/plans/message-biblestudy-proposed-schema.md` | Proposed table merge: schema, migration plan, workflow walkthrough, TOAST analysis, alternative approaches evaluated |
