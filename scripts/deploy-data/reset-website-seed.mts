...
await createPageWithSections(
  ...
  [
    { sectionType: 'HERO_BANNER', label: 'Hero', colorScheme: 'DARK', content: { heading: { line1: 'Welcome to', line2: 'LA UBF' }, subheading: "Where people find their community.\nWhere disciples are raised.\nWhere the Word of God is lived.", primaryButton: { label: "I'm new", href: '/im-new', visible: true }, secondaryButton: { label: 'Upcoming events', href: '/events', visible: true }, backgroundImage: { src: `${CDN}/compressed-hero-vid.mp4`, alt: 'LA UBF community gathering' }, mobileVideo: { src: `${CDN}/compressed-hero-vid-mobile.webm` } } },
