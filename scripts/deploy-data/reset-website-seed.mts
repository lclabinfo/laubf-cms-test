...
await createPageWithSections(
  ...
  [
    ...
    { sectionType: 'EVENT_CALENDAR', label: 'Schedule', colorScheme: 'LIGHT', content: { heading: 'Schedule', filters: ['ALL', 'Events', 'Meetings', 'Programs'], ctaButtons: [ { label: '2026 LA UBF Calendar', href: 'https://laubf.org/calendar', icon: true }, { label: 'View all events', href: '/events' } ], dataSource: 'upcoming-events' } },
