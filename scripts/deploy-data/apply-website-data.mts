/**
 * Apply website builder data to the database.
 *
 * This script creates/replaces all website-managed DB records:
 ...
 *
 * Usage: npx tsx scripts/deploy-data/apply-website-data.mts
 */
...
const ministryGroups = [
  ...
  { label: 'Children (CBF)', href: '/ministries/children', iconName: 'baby', groupLabel: 'Ministry Groups', sortOrder: 3 },
]
...
await createPageWithSections(
  ...
  [
    { sectionType: 'HERO_BANNER', label: 'Hero', colorScheme: 'DARK', content: { heading: { line1: 'Welcome to', line2: 'LA UBF' }, subheading: "Where people find their community.\nWhere disciples are raised.\nWhere the Word of God is lived.", primaryButton: { label: "I'm new", href: '/im-new', visible: true }, secondaryButton: { label: 'Upcoming events', href: '/events', visible: true }, backgroundImage: { src: `${CDN}/compressed-hero-vid.mp4`, alt: 'LA UBF community gathering' } } },
    ...
    { sectionType: 'HIGHLIGHT_CARDS', label: 'Featured Events', colorScheme: 'LIGHT', content: { heading: 'Featured Events', subheading: "Highlights of what's happening in our community.", ctaLabel: 'View All Events', ctaHref: '/events', dataSource: 'featured-events' } },
    { sectionType: 'EVENT_CALENDAR', label: 'Schedule', colorScheme: 'LIGHT', content: { heading: 'Schedule', filters: ['ALL', 'Events', 'Meetings', 'Programs'], ctaButtons: [ { label: '2026 LA UBF Calendar', href: 'https://laubf.org/calendar?month=2', icon: true }, { label: 'View all events', href: '/events' } ], dataSource: 'upcoming-events' } },
...
await createPageWithSections(
  ...
  [
    { sectionType: 'SPOTLIGHT_MEDIA', label: "This Week's Message", colorScheme: 'DARK', paddingY: 'COMPACT', content: { sectionHeading: "This Week\u2019s Message", dataSource: 'latest-message' } },
...
await createPageWithSections(
  ...
  [
    { sectionType: 'DAILY_BREAD_FEATURE', label: 'Daily Bread', colorScheme: 'LIGHT', content: { dataSource: 'latest-daily-bread' } },
  ],
)
...
const ministriesPage = await createPageWithSections(
  ...
  [
    ...
    { sectionType: 'CAMPUS_CARD_GRID', label: 'Join a Campus Ministry', colorScheme: 'LIGHT', content: { ...sharedCampusGrid, overline: 'Are you a college student?', ctaButton: { label: 'Let us know your interest', href: '/im-new#plan-visit' } } },
    { sectionType: 'NEWCOMER', label: 'Newcomer CTA', colorScheme: 'DARK', content: sharedNewcomer },
  ],
)
...
async function createCampusPage(opts: {
  ...
  await createPageWithSections(
    ...
    [
      ...
      { sectionType: 'FAQ_SECTION', label: `${opts.slug.toUpperCase()} FAQ`, colorScheme: 'LIGHT', containerWidth: 'NARROW', content: sharedCampusFaq(opts.campusName) },
...
await createPageWithSections(
  ...
  [
    { sectionType: 'LOCATION_DETAIL', label: 'Visit Info', colorScheme: 'LIGHT', content: { overline: "I'M NEW", heading: "You're Invited", description: 'We know that visiting a new church can be intimidating. We want you to feel welcome and comfortable.', mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3313.8!2d-118.132!3d33.947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2ce8c5b14b897%3A0x4efd9e47d90c96ec!2s11625%20Paramount%20Blvd%2C%20Downey%2C%20CA%2090241!5e0!3m2!1sen!1sus!4v1690000000000', address: ['11625 Paramount Blvd,', 'Downey, CA 90241'], directionsUrl: 'https://maps.google.com/?q=11625+Paramount+Boulevard+Downey+CA', serviceLabel: 'Sunday Worship Service', serviceTime: '11:00 AM \u2013 12:30 PM', parking: 'Free parking available in our lot behind the building. Street parking also available on Paramount Blvd.' } },
    { sectionType: 'FORM_SECTION', label: 'Plan Your Visit', colorScheme: 'LIGHT', content: sharedFormContent },
    { sectionType: 'FAQ_SECTION', label: 'FAQ', colorScheme: 'LIGHT', containerWidth: 'NARROW', content: { heading: 'Frequently Asked Questions', showIcon: true, items: [ { question: 'Where is LA UBF?', answer: 'We are located at 11625 Paramount Blvd, Downey, CA 90241. Free parking is available behind the building.' }, { question: 'What should I expect?', answer: "Our Sunday worship service includes singing, a Bible message, and fellowship. It\u2019s about an hour and a half. Casual dress is welcome!" }, { question: 'Can I bring my kids?', answer: "Absolutely! We have a children\u2019s ministry (CBF) that runs during the service with age-appropriate Bible lessons and activities." }, { question: 'I\u2019m a college student. Is this for me?', answer: "Yes! LA UBF has campus Bible study groups across many universities. We\u2019d love to connect you with a group on your campus." }, { question: 'What denomination is UBF?', answer: 'UBF is a non-denominational evangelical Christian organization focused on Bible study and discipleship.' } ] } },
  ],
)
...
// ── CONTACT PAGE ───────────────────────────────────────────
await createPageWithSections(
  { slug: 'contact', title: 'Contact', metaDescription: 'Get in touch with LA UBF \u2014 we\u2019d love to hear from you.', sortOrder: 14 },
  [
    { sectionType: 'LOCATION_DETAIL', label: 'Contact Info', colorScheme: 'LIGHT', content: { overline: 'CONTACT US', heading: 'Get in Touch', description: "Have a question or want to learn more? We\u2019d love to hear from you.", mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3313.8!2d-118.132!3d33.947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2ce8c5b14b897%3A0x4efd9e47d90c96ec!2s11625%20Paramount%20Blvd%2C%20Downey%2C%20CA%2090241!5e0!3m2!1sen!1sus!4v1690000000000', address: ['11625 Paramount Blvd,', 'Downey, CA 90241'], directionsUrl: 'https://maps.google.com/?q=11625+Paramount+Boulevard+Downey+CA', contactEmail: 'laubf.downey@gmail.com', contactPhone: '(562) 396-6350' } },
    { sectionType: 'FORM_SECTION', label: 'Contact Form', colorScheme: 'LIGHT', content: { ...sharedFormContent, overline: 'Contact Us', heading: "Send us a message", description: "Fill out the form below and we\u2019ll get back to you as soon as possible." } },
  ],
)
...
await createPageWithSections(
  ...
  [
    { sectionType: 'PAGE_HERO', label: 'Giving Hero', colorScheme: 'LIGHT', content: { overline: 'GIVING', heading: 'Giving' } },
    { sectionType: 'STATEMENT', label: 'Giving Info', colorScheme: 'LIGHT', content: { heading: 'Giving', paragraphs: [ { text: 'This page is coming soon.', isBold: false } ] } },
  ],
)
