...
--
-- Table structure for table `a_tn3_memberboard_msg_mylist`
--

DROP TABLE IF EXISTS `a_tn3_memberboard_msg_mylist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn3_memberboard_msg_mylist` (
...
--
-- Dumping data for table `a_tn3_memberboard_msg_mylist`
--

LOCK TABLES `a_tn3_memberboard_msg_mylist` WRITE;
/*!40000 ALTER TABLE `a_tn3_memberboard_msg_mylist` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn3_memberboard_msg_mylist` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:13:57
