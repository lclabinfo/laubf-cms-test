...
--
-- Table structure for table `a_tn2_mobhome_list`
--

DROP TABLE IF EXISTS `a_tn2_mobhome_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_mobhome_list` (
  `no` int NOT NULL AUTO_INCREMENT,
  `board_name` varchar(50) NOT NULL DEFAULT 'mobhome',
...
--
-- Dumping data for table `a_tn2_mobhome_list`
--

LOCK TABLES `a_tn2_mobhome_list` WRITE;
/*!40000 ALTER TABLE `a_tn2_mobhome_list` DISABLE KEYS */;
INSERT INTO `a_tn2_mobhome_list` VALUES (1,'mobhome',-1,1,0,NULL,1,0,NULL,1,NULL,NULL,NULL,NULL,0,0,'',0,'120.53.41.22',1300757600,NULL,6,NULL,NULL,NULL,'?덊럹?댁? ?곌껐 蹂대뱶?낅땲?',0,'admin','','',NULL,NULL,NULL,'',0,NULL,'??寃뚯떆?먯? \r\n硫붿씤 ?덊럹?댁? ?곌껐 ?듬줈濡??ъ슜?섎뒗 蹂대뱶?대땲\r\n??젣?섏? 留먭퀬 洹몃깷 ?대?濡??좎? ?섏떗?쒖삤.',NULL,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `a_tn2_mobhome_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:08:33
