...
--
-- Table structure for table `a_tn2_epray_list`
--

DROP TABLE IF EXISTS `a_tn2_epray_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_epray_list` (
  `no` int NOT NULL AUTO_INCREMENT,
  `board_name` varchar(50) NOT NULL DEFAULT 'epray',
...
--
-- Dumping data for table `a_tn2_epray_list`
--

LOCK TABLES `a_tn2_epray_list` WRITE;
/*!40000 ALTER TABLE `a_tn2_epray_list` DISABLE KEYS */;
INSERT INTO `a_tn2_epray_list` VALUES (1,'epray',-1,1,0,NULL,1,0,NULL,NULL,1,NULL,NULL,NULL,0,0,'Prayer',4,'222.22.22.22',1486772106,NULL,24,NULL,NULL,NULL,'World Mission Prayer Topics',0,'','whcho2','danylight@gmail.com',NULL,NULL,NULL,'k3GH1.RB9eEYE',0,NULL,'Let\\\'s pray for\r\n\r\nRaising 100,000 Bible teachers and missionaries through one-to-one Bible study and discipleship ministry;\r\n\r\nEvangelization of all 7,000 major campuses of the world in this generation.&#8203;&#8203;\r\n\r\nPray for\r\n All leaders in our ministry continually fix our eyes on Jesus so that we may grow to bear the image of the Good Shepherd Jesus;\r\nAll leaders raise disciples as Jesus raised his disciples by showing them his own example and teaching them God?셲 word of truth;\r\n\r\nGod raises thousands of missionaries, both young and old, from USA/Canada and UBF worldwide and sends them out to the ends of the earth.\r\n\r\n ',NULL,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `a_tn2_epray_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:14:42
