...
--
-- Table structure for table `a_tn2_mobpray_re`
--

DROP TABLE IF EXISTS `a_tn2_mobpray_re`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_mobpray_re` (
...
--
-- Dumping data for table `a_tn2_mobpray_re`
--

LOCK TABLES `a_tn2_mobpray_re` WRITE;
/*!40000 ALTER TABLE `a_tn2_mobpray_re` DISABLE KEYS */;
INSERT INTO `a_tn2_mobpray_re` VALUES (23,11,'議곗썝?','議곗썝?','whcho','?깃꼍?쎄린?쒕퉬???뚭컻瑜??꾪빐?쒕룄 湲곕룄?댁＜?몄슂',NULL,'k3GH1.RB9eEYE','211.192.65.60',1400310396,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,'');
/*!40000 ALTER TABLE `a_tn2_mobpray_re` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:08:30
