...
--
-- Table structure for table `a_tn2_prayertopics_re`
--

DROP TABLE IF EXISTS `a_tn2_prayertopics_re`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_prayertopics_re` (
...
--
-- Dumping data for table `a_tn2_prayertopics_re`
--

LOCK TABLES `a_tn2_prayertopics_re` WRITE;
/*!40000 ALTER TABLE `a_tn2_prayertopics_re` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn2_prayertopics_re` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:15:27
