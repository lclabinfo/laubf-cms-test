...
--
-- Table structure for table `a_tn2_youthevent_re`
--

DROP TABLE IF EXISTS `a_tn2_youthevent_re`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_youthevent_re` (
...
--
-- Dumping data for table `a_tn2_youthevent_re`
--

LOCK TABLES `a_tn2_youthevent_re` WRITE;
/*!40000 ALTER TABLE `a_tn2_youthevent_re` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn2_youthevent_re` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:14:50
