...
--
-- Table structure for table `a_tn2_IBSMessage_list`
--

DROP TABLE IF EXISTS `a_tn2_IBSMessage_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_IBSMessage_list` (
  `no` int NOT NULL AUTO_INCREMENT,
  `board_name` varchar(50) NOT NULL DEFAULT 'IBSMessage',
...
--
-- Dumping data for table `a_tn2_IBSMessage_list`
--

LOCK TABLES `a_tn2_IBSMessage_list` WRITE;
/*!40000 ALTER TABLE `a_tn2_IBSMessage_list` DISABLE KEYS */;
INSERT INTO `a_tn2_IBSMessage_list` VALUES (1,'IBSMessage',-1,1,0,NULL,1,0,NULL,1,1,NULL,NULL,NULL,0,0,'joseph',0,'0.0.0.0',1550974392,NULL,0,NULL,NULL,NULL,'Missionary Mark Yang\'s Bible study and lecture materials.',0,'Mark C Yang','joseph','whcho@kookmin.ac.kr',NULL,NULL,NULL,'',0,NULL,'This is Missionary Mark Yang\'s Bible study and lecture materials board.\r\nMissionary Mark Yang will upload his Bible Study materials directly.',NULL,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,NULL,'LA Church',NULL,NULL);
/*!40000 ALTER TABLE `a_tn2_IBSMessage_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:06:45
