...
--
-- Table structure for table `a_tn2_BibleForest_re`
--

DROP TABLE IF EXISTS `a_tn2_BibleForest_re`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_BibleForest_re` (
...
--
-- Dumping data for table `a_tn2_BibleForest_re`
--

LOCK TABLES `a_tn2_BibleForest_re` WRITE;
/*!40000 ALTER TABLE `a_tn2_BibleForest_re` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn2_BibleForest_re` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:05:15
