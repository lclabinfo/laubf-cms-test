...
--
-- Table structure for table `a_tn2_esubpray_re`
--

DROP TABLE IF EXISTS `a_tn2_esubpray_re`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_esubpray_re` (
...
--
-- Dumping data for table `a_tn2_esubpray_re`
--

LOCK TABLES `a_tn2_esubpray_re` WRITE;
/*!40000 ALTER TABLE `a_tn2_esubpray_re` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn2_esubpray_re` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:14:47
