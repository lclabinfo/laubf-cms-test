...
--
-- Table structure for table `a_tn2_praisenight_list`
--

DROP TABLE IF EXISTS `a_tn2_praisenight_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_praisenight_list` (
...
--
-- Dumping data for table `a_tn2_praisenight_list`
--

LOCK TABLES `a_tn2_praisenight_list` WRITE;
/*!40000 ALTER TABLE `a_tn2_praisenight_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn2_praisenight_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:12:36
