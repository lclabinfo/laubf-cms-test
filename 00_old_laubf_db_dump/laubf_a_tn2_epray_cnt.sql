...
--
-- Table structure for table `a_tn2_epray_cnt`
--

DROP TABLE IF EXISTS `a_tn2_epray_cnt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_epray_cnt` (
...
--
-- Dumping data for table `a_tn2_epray_cnt`
--

LOCK TABLES `a_tn2_epray_cnt` WRITE;
/*!40000 ALTER TABLE `a_tn2_epray_cnt` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn2_epray_cnt` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:14:19
