...
--
-- Table structure for table `a_tn2_message_list`
--

DROP TABLE IF EXISTS `a_tn2_message_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `a_tn2_message_list` (
  `no` int NOT NULL AUTO_INCREMENT,
  `board_name` varchar(50) NOT NULL DEFAULT 'dbshare2',
...
--
-- Dumping data for table `a_tn2_message_list`
--

LOCK TABLES `a_tn2_message_list` WRITE;
/*!40000 ALTER TABLE `a_tn2_message_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_tn2_message_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 14:13:23
