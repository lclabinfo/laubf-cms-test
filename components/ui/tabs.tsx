  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:border-border dark:data-active:text-foreground dark:data-active:border-[oklch(0.45_0_0)] dark:data-active:bg-input/30 data-active:text-foreground",
