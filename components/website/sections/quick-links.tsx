  ...
  return (
    <div className="min-w-[280px] max-w-[300px] shrink-0 snap-start bg-white-0 rounded-[20px] border border-white-2-5 shadow-[0px_12px_20px_0px_rgba(0,0,0,0.05)] p-6 flex flex-col">
      ...
      <div className="mt-auto flex flex-col gap-2">
        ...
        <Link
          href={resolveHref(`/events/${meeting.slug}`)}
...
function MobileQuickLinksList({ meetings }: { meetings: Meeting[] }) {
    ...
    <div className="flex flex-col gap-2">
      {visible.map((meeting) => (
        ...
        >
          ...
          {/* Right: link button */}
          <a
            href={meeting.meetingUrl ?? resolveHref(`/events/${meeting.slug}`)}
