...
async function main() {
  ...
  // --- People: speakers + all legacy members ---
  // Speakers have title/bio; legacy members imported from old LA UBF user accounts and email list.
  // Paul Im was merged into Paul Lim (same person, different name in legacy data).
  const speakerPersonData: { name: string; slug: string; firstName: string; lastName: string; email?: string; title?: string; bio?: string; source?: string }[] = [
    // Speakers (from message data)
    { name: 'William Larsen', slug: 'william-larsen', firstName: 'William', lastName: 'Larsen', email: 'williamjlarsen@gmail.com', title: 'Senior Pastor', bio: 'Pastor William Larsen has served as the senior shepherd of LA UBF since its founding. He leads the Sunday worship service and weekly Bible study.' },
    { name: 'John Kwon', slug: 'john-kwon', firstName: 'John', lastName: 'Kwon', email: 'johnkwon121@gmail.com', title: 'Associate Pastor' },
    { name: 'David Park', slug: 'david-park', firstName: 'David', lastName: 'Park', email: 'davidwanp@gmail.com', title: 'Associate Pastor' },
    { name: 'Robert Fishman', slug: 'robert-fishman', firstName: 'Robert', lastName: 'Fishman', email: 'rfishman2@gmail.com', title: 'Campus Minister' },
    { name: 'Ron Ward', slug: 'ron-ward', firstName: 'Ron', lastName: 'Ward', title: 'Bible Teacher' },
    { name: 'Troy Segale', slug: 'troy-segale', firstName: 'Troy', lastName: 'Segale', email: 'tsegale@gmail.com', title: 'Campus Minister' },
    { name: 'Frank Holman', slug: 'frank-holman', firstName: 'Frank', lastName: 'Holman', email: 'franklin.holman@gmail.com', title: 'Bible Teacher' },
    { name: 'David Min', slug: 'david-min', firstName: 'David', lastName: 'Min', title: 'Bible Teacher' },
    { name: 'Paul Lim', slug: 'paul-lim', firstName: 'Paul', lastName: 'Lim', email: 'lseu8@cs.com', title: 'Bible Teacher' },
    ...
    { name: 'James Park', slug: 'james-park', firstName: 'James', lastName: 'Park', email: 'jpark90241@yahoo.com', title: 'Bible Teacher' },
    { name: 'Andrew Cuevas', slug: 'andrew-cuevas', firstName: 'Andrew', lastName: 'Cuevas', email: 'awcuevas@gmail.com', title: 'Bible Teacher' },
    { name: 'Joshua Lopez', slug: 'joshua-lopez', firstName: 'Joshua', lastName: 'Lopez', email: 'joshua.lopez.g@gmail.com', title: 'Bible Teacher' },
    { name: 'Juan Perez', slug: 'juan-perez', firstName: 'Juan', lastName: 'Perez', email: 'jvperez13@gmail.com', title: 'Bible Teacher' },
    { name: 'Jason Koch', slug: 'jason-koch', firstName: 'Jason', lastName: 'Koch', email: 'jkoch7@gmail.com', title: 'Bible Teacher' },
    { name: 'Isiah Pulido', slug: 'isiah-pulido', firstName: 'Isiah', lastName: 'Pulido', email: 'waytruthlifeinchrist@gmail.com', title: 'Bible Teacher' },
    // Legacy members (from old LA UBF user accounts + email list)
    ...
    { slug: 'isaiah-pulido', firstName: 'Isaiah', lastName: 'Pulido', email: 'waytruthlifeinchrist@gmail.com', source: 'Legacy user account' },
    ...
    // Email-list-only contacts (not in legacy user accounts)
  ...
  for (const sp of speakerPersonData) {
    const person = await prisma.person.upsert({
      ...
      update: { title: sp.title, bio: sp.bio, email: sp.email },
      create: {
        churchId,
        slug: sp.slug,
        ...
        source: sp.source ?? 'Speaker from message data',
      },
    })
    personRecords[sp.slug] = person.id
  }
  console.log(`  Created ${Object.keys(personRecords).length} people (speakers + legacy members)`)
