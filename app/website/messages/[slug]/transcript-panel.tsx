...
import { IconFileText } from "@/components/website/shared/icons";
...
export default function TranscriptPanel({
  ...
  const hasRaw = !!rawTranscript;

  // Don't render if no transcripts
  if (!hasLive && !hasRaw) return null;
  ...
  const tabs: { key: TranscriptTab; label: string; disabled?: boolean }[] = [
    ...
    { key: "raw", label: "Message Text", disabled: !hasRaw },
  ];
